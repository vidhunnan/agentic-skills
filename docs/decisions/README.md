...
| [0026](./0026-versions-are-per-skill-bumped-only-when-that-skill-changes.md) | Versions are per skill, bumped only when that skill changes | 2026-08-24 | Accepted | 0 | `docs/VERSIONING.md` §The unit of release |

*26 decisions logged; 23 stand. [0022](./0022-generation-is-allowed-only-into-explorations.md) narrows [0021](./0021-design-skills-never-make-the-design-decision.md) without superseding it — the scope changed, the decision did not.*
